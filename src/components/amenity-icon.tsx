...
// Diekstrak dari property-amenities.tsx supaya halaman brosur (server component, tanpa JS) bisa memakai
// glyph yang sama dengan halaman detail. Tanpa "use client": murni SVG, tidak ada state.
...
export default function AmenityIconGlyph({ name }: { name: AmenityIcon }) {
