...
export default async function PropertyDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <PropertySiteChrome contact={contact}><main className={styles.page}>
    {/* Kop dan kaki khusus cetak sudah tidak ada di sini: brosur punya halamannya sendiri di
        /properti/[id]/brosur dengan tata letak kertas, bukan hasil menyembunyikan bagian halaman ini. */}
