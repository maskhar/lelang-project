...
const sections: PolicySection[] = [
  ...
  { title: "11. Hak Anda", paragraphs: ["Sesuai ketentuan yang berlaku, Anda dapat meminta informasi tentang pemrosesan Data Pribadi, akses, perbaikan data yang tidak akurat, penarikan persetujuan, penghapusan, penghentian pemrosesan tertentu, atau mengajukan keberatan dan keluhan. Kami dapat meminta verifikasi identitas sebelum menindaklanjuti permintaan dan dapat membatasi permintaan tertentu bila terdapat kewajiban hukum atau alasan sah lainnya."] },
