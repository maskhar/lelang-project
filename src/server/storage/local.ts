...
// JANGAN panggil ini langsung untuk file media bucket public: sejak 0016 satu file dipakai banyak baris
// property_media (revisi berbagi file), jadi penghapusan wajib lewat discardIfUnreferenced/discardUnreferenced
// di media/refcount.ts yang memeriksa pemakai sisa lebih dulu.
